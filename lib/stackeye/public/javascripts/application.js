...
var Dropdowns = function() {
    ...
    Highlight = void $(".highlight").each(function(a, t) {
        var e;
        e = t, hljs.highlightBlock(e)
    }),
    Flatpickr = function() {
        var a = $("#formControlFlatpickr");
    ...
    Lists = function() {
        ...
        a.length && a.each(function() {
            ...
            a = $(this), new List(a.get(0), {
                valueNames: (t = a).data("lists-values"),
                listClass: t.data("lists-class") ? t.data("lists-class") : "list"
            })
        }), t.on("click", function() {
            return !1
        })
